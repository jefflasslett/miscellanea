...
hi Type       term=underline ctermfg=Cyan                       cterm=underline guifg=Cyan                  gui=underline
hi Function                  ctermfg=Cyan                       cterm=bold      guifg=Cyan                  gui=bold 
...
hi Visual                    ctermfg=White       ctermbg=Grey                   guifg=White    guibg=Grey 
